class Todo {
  ...
  updateUI() {
    const activeTasksCount = this.state.items.filter(item => !item.isChecked).length;
    ...
    this.deleteButtonElement.classList.toggle(this.stateClasses.isVisible, hasCompletedTasks);
